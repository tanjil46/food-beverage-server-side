...
app.get('/',(req,res)=>{
    ...
    res.send('FOOD AND BEVERAGE SERVER IS STARTING')
...
const uri = "mongodb+srv://foodserver:hntwvPGzIcsmpfLP@cluster0.u2o3a1l.mongodb.net/?retryWrites=true&w=majority";
